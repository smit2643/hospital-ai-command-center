...
class PatientRegistrationForm(BaseRegistrationForm):
    ...
    chronic_conditions = forms.CharField(required=False, widget=forms.Textarea(attrs={"rows": 2}))
    current_medications = forms.CharField(required=False, widget=forms.Textarea(attrs={"rows": 2}))
    insurance_provider = forms.CharField(max_length=120, required=False)
    insurance_policy_number = forms.CharField(max_length=120, required=False)
    emergency_contact_name = forms.CharField(max_length=120, required=False)
    emergency_contact_relation = forms.CharField(max_length=60, required=False)
